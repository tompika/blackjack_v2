...
/**
 * A lejátszott játszámák megjelenítéséhez szükséges osztály, a TableView feltöltéséhez szükséges. 
 * 
 * 
...
public class Round {
	 	...
	 	/**
	 	 * Az eredmények menüpont alatt található táblázat köreinek reprezentációjához.
